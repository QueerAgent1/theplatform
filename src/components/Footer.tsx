      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold mb-4">QueerLuxe Travel Studio</h3>
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#D4AF37]">Company</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#D4AF37]">Resources</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-[#D4AF37]">Legal</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-center">
            &copy; {new Date().getFullYear()} QueerLuxe Travel Studio. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
